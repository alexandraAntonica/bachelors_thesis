...
rgi_df = pd.read_csv("/Users/alexandra/Desktop/thesis_programming/data/rgi_results_SA/resistance_matrix.csv")
gene_df = pd.read_csv("/Users/alexandra/Desktop/thesis_programming/data/panaroo_output_SA/gene_presence_absence.csv")
mlst_df = pd.read_csv("/Users/alexandra/Desktop/thesis_programming/mlst_results_SA.csv")
...
# Keep the columns corresponding to the AMG, TET, and BAC drugs
new_df = rgi_df[["Unnamed: 0","aminoglycoside antibiotic", "tetracycline antibiotic", "peptide antibiotic"]]
new_df = new_df.rename(columns={"Unnamed: 0": "sample_ID","aminoglycoside antibiotic": "AMG","tetracycline antibiotic": "TET", "peptide antibiotic": "BAC"})



# Create SNPs matrix and prepare for merging
callset = allel.read_vcf("/Users/alexandra/Desktop/thesis_programming/data/panaroo_output_SA/core_gene_alignment.vcf")
...
# Save to CSV
final_df.to_csv("final_SA.csv", index=False)
