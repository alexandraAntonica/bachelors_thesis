...
rgi_df = pd.read_csv("/Users/alexandra/Desktop/thesis_programming/data/rgi_results_SP/resistance_matrix.csv")
gene_df = pd.read_csv("/Users/alexandra/Desktop/thesis_programming/data/panaroo_output_SP/gene_presence_absence.csv")
mlst_df = pd.read_csv("/Users/alexandra/Desktop/thesis_programming/mlst_results_SP.csv")
...
# Keep the columns corresponding to the CHL, TET, and AZM drugs
new_df = rgi_df[["Unnamed: 0","phenicol antibiotic", "tetracycline antibiotic", "macrolide antibiotic; lincosamide antibiotic; streptogramin antibiotic; streptogramin A antibiotic; streptogramin B antibiotic"]]
new_df = new_df.rename(columns={"Unnamed: 0": "sample_ID","phenicol antibiotic": "CHL","tetracycline antibiotic": "TET", "macrolide antibiotic; lincosamide antibiotic; streptogramin antibiotic; streptogramin A antibiotic; streptogramin B antibiotic": "AZM"})



# Create SNPs matrix and prepare for merging
callset = allel.read_vcf("/Users/alexandra/Desktop/thesis_programming/data/panaroo_output_SP/core_gene_alignment.vcf")
...
# Reset index to turn sample_ID into a column
...
# Save to CSV
final_df.to_csv("final_SP.csv", index=False)
